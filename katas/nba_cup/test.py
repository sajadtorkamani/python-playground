import unittest
from solution import nba_cup

results = ("Los Angeles Clippers 104 Dallas Mavericks 88,New York Knicks 101 Atlanta Hawks 112,Indiana Pacers 103 Memphis Grizzlies 112,"
...
class SolutionTest(unittest.TestCase):
    def test_returns_correct_result(self):
        ...
        self.assertEqual(
            ...
            nba_cup(results, "Boston Celtics"))

        self.assertEqual("", nba_cup(results, ""))

        self.assertEqual(nba_cup(results, "Boston Celt"),
